...
% -------------------------------------------------
% Set up new layers for the debugging marks
% \pgfsetlayers sets the order of layers
\pgfdeclarelayer{marx}
\pgfdeclarelayer{background}
\pgfsetlayers{background,marx}
...
\begin{tikzpicture}[%
    ...
    node distance=6mm and 60mm, % Global setup of box spacing, change 60mm for distance
...
% ------------------------------------------------- 
% Start the settings of layer marx
\begin{pgfonlayer}{marx}
% -------------------------------------------------
...
% Delete \cmark to make numbers disappear
...
\node [proc, fill=green!15, dotted, thick,text height=5cm, text width=13cm]  at (3,0) (big1) {};
\node [above=-12mm of big1, it] at (8,0) {(Iteration1)};
\node [proc, fill=red!15, dotted, thick,text height=5cm, text width=13cm]  at (3,-9) (big2) {};
\node [above=-12mm of big2, it] at (8,-9) {(Iteration2)};
\end{pgfonlayer}
